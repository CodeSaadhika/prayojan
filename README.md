...
## New Portfolio Site
- [ ] Create a new portfolio with learned skills
  - [ ] Create a new UI/UX design and prototype in Figma
    - [ ] Create a Design System
    - [ ] Create design for header and footer
    - [ ] Create design for home page and all page sections
    - [ ] Create design for blog articles listing page, with categories and tags listted in right sidebar
    - [ ] Create design for blog article page, with relevant information like author, date, category, tags, and other recent articles in the right sidebar
    - [ ] Create design for admin login page (no registration)
    - [ ] Create design for admin dashboard with ability to update person information and other details used in the portfolio including updating admin password
    - [ ] Create design for blog articles listing with option to create,view,edit, publish and unpublish articles
    - [ ] Create design for blog article edit page with option to publish, unpublish, delete article, and assign categories and tags
    - [ ] Create design for blog article create page with option to draft, create, publish articles, and assign categories and tags
    - [ ] Create design for blog categories listing page
    - [ ] Create design for category create and edit category
    - [ ] Create design for page for creating and editing article tags
    - [ ] Create design for a page containing all images with options to, display uploaded images, upload images and delete existing ones
  - [ ] Design a database either in MongoDB or MySQL, in accordance with the UI design, create the database, and host it online
  - [ ] Create a backend that connects with the database, and implements services and APIs for admin and portfolio UI and serves the required data
  - [ ] Implement the Figma UI/UX in React
    - [ ] Implement the Design System
    - [ ] Implement header and footer
    - [ ] Implement a homepage and sections including a functional contact form section
    - [ ] Implement the blog listing page with blog item card and other necessary child components
    - [ ] Implement the blog article page
    - [ ] Implement the blog categories listing page
    - [ ] Implement the category articles listing page
    - [ ] Implement the tag article listing page
    - [ ] Implement the admin login page and login functionality with JWT
    - [ ] Implement the dashboard page
    - [ ] Implement the blogs listing page, editing page, creating page. Individual articles page has ability to assign categories and tags, draft new articles, publish/unpublish new and existing articles
    - [ ] Implement the blog categories listing page, editing page, creating page
    - [ ] Implement one page to list, edit, create tags
    - [ ] Connect the frontend with the Django backend to fetch data for sections and pages with requests to relevant APIs
